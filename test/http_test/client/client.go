...
type Client interface {
	...
	UpdateDevice(ctx context.Context, deviceID string, body models2.UpdateDeviceRequest) (models2.UpdateDeviceResponse, *http.Response, error)
}
...
func (c *client) UpdateDevice(ctx context.Context, deviceID string, body models2.UpdateDeviceRequest) (models2.UpdateDeviceResponse, *http.Response, error) {
	var localResponse models2.UpdateDeviceResponse
	...
	data, _ := ioutil.ReadAll(res.Body)
	device := new(models2.UpdateDeviceResponse)
	err = json.Unmarshal(data, &device)
	if err != nil {
		return localResponse, res, err
	}
